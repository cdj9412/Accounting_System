...
public class VideoDailyViewsReader {
    ...
    @Bean
    @StepScope
    public JpaPagingItemReader<VideoDailyViewsEntity> videoDailyViewsEntityReader(
        ...
        return new JpaPagingItemReaderBuilder<VideoDailyViewsEntity>()
                ...
                .queryString("SELECT v FROM video_daily_views v WHERE v.date = :yesterday") // 어제 날짜
